...
def encrypt_image(image_path, key):
    ...
    encrypted_image.save(r'C:\Users\USER\code\IMAGES\encrypted_image.png')
...
def decrypt_image(encrypted_image_path, key):
    ...
    decrypted_image.save(r'C:\Users\USER\code\IMAGES\decrypted_image.png')
    print("Image decrypted and saved as 'decrypted_image.png' in the IMAGES folder.")

# Example usage
key = 50  # Change this key to anything you like
encrypt_image(r'C:\Users\USER\code\IMAGES\input_image.png', key)
decrypt_image(r'C:\Users\USER\code\IMAGES\encrypted_image.png', key)